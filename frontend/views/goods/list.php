		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="goodslist mt10">
				...
				<ul>
					<li>
						<dl>
							<dt><a href="<?=\yii\helpers\Url::to(['goods/goods','id'=>$model->id])?>"><img src="<?=$model->logo?>" alt="" /></a></dt>
							<dd><a href="<?=\yii\helpers\Url::to(['goods/goods','id'=>$model->id])?>"><?=$model->name?></a></dt>
							<dd><strong><?=$model->market_price?></strong></dt>
							<dd><a href=""><em></em></a></dt>
						</dl>
					</li>
				</ul>
                <?php endforeach;?>
