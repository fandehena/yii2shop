	...
	<div class="topnav">
		<div class="topnav_bd w1210 bc">
			...
			<div class="topnav_right fr">
				<ul>
					<li>你好，欢迎来到京西！[<a href="<?=\yii\helpers\Url::to(['member/login'])?>">登录</a>][<a href="<?=\yii\helpers\Url::to(['member/register'])?>">免费注册</a>] </li>
					<li class="line">|</li>
					<li>我的订单</li>
					<li class="line">|</li>
					<li>客户服务</li>
		...
		<div class="nav w1210 bc mt10">
			...
			<div class="category fl"> <!-- 非首页，需要添加cat1类 -->
				...
				<div class="cat_bd">
					...
					<div class="cat">
						<h3><a href="<?=\yii\helpers\Url::to(['goods/list','id'=>$model->id])?>"><?=$model->name?></a><b></b></h3>
						<div class="cat_detail">
                            <?php $goods=\backend\models\GoodsCategory::find()->where(['parent_id'=>$model->id])->all()?>
                            <?php foreach ($goods as $good):?>
							<dl class="dl_1st">
								<dt><a href="<?=\yii\helpers\Url::to(['goods/list','id'=>$good->id])?>"><?=$good->name?></a></dt>
                                <?php $childs=\backend\models\GoodsCategory::find()->where(['parent_id'=>$good->id])->all()?>
                                <?php foreach($childs as $child):?>
								<dd>
                                    <a href="<?=\yii\helpers\Url::to(['goods/list','id'=>$child->id])?>"><?=$child->name?></a>
								</dd>
                                <?php endforeach;?>
							</dl>
                            <?php endforeach;?>
