        ...
        <div class="login_form fl">
            <form  id="signupForm" action="" method="post">
                <ul>
                    ...
                    <li>
                        <label for="">验证码：</label>
                        <input type="text" class="txt" value="" placeholder="请输入短信验证码" name="code" disabled="disabled" id="code"/> <input type="button" onclick="bindPhoneNum(this)" id="get_code" value="获取验证码" style="height: 25px;padding:3px 8px"/>
...
//                    minlength: 2,
//                    //远程异步验证
//                    remote: "<?//=\yii\helpers\url::to(['member/member-name'])?>//"
//                },
//                password:{
//                    required:true,
//                    minlength:6,
...
//            },
        ...
        $('#get_code').click(function () {
            var tel = $('#tel').val();
            $.get("sms.html",{tel:tel},function (arr) {
                console.log(arr);
            })
        });
