...
<div class="main w1210 bc mt10">
    ...
    <div class="content fl ml10">
        <div class="address_hd">
            ...
            <dl >
                <dt><?=$member->username?> <?=$member->provence?> <?=$member->city?> <?=$member->area?> <?=$member->address?> <?=$member->tel?> </dt>
                <dd edit-id="<?=$member->id?>">
                    <a href="" class="edit" onclick="return false">修改</a>
                    <a href="<?=\yii\helpers\Url::to(['address/delete','id'=>$member->id])?>">删除</a>
                    <a href="">设为默认地址</a>
                </dd>
            </dl>
            <?php endforeach;?>
...
<script type="text/javascript">
    ...
    $('.edit').click(function () {
        ...
        $.get('edit.html',data,function(arr) {
            $('#username').attr('value',arr['username']);
            $('#tel').attr('value',arr['tel']);
            $('#address').attr('value',arr['address']);
            addressInit('cmbProvince', 'cmbCity', 'cmbArea','',arr['provence'],arr['city'],arr['area'],'');
