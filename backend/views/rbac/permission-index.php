...
<thead>
    ...
    <?php foreach($permissions as $permission):?>
        <tr>
            ...
            <td><a class="btn btn-primary" href="<?=\yii\helpers\Url::to(['rbac/permission-edit','name'=>$permission->name] )?>">修改</a>
                <a href="<?=\yii\helpers\Url::to(['rbac/delete-permission','name'=>$permission->name])?>" class="btn btn-danger">删除</a></td>
        </tr>
    <?php endforeach;?>
